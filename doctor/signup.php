...
if(isset($_POST['submit']))
  {
    ...
    $mobno=$_POST['mobno'];
    $email=$_POST['email'];
	$accessCodeInput = $_POST['Acc_code']; // Access Code validation
	...
	<form action="" method="post">
		...
		<div class="form-group">
			<div class="input-group">
				...
				<input id="Acc_code" type="password" class="form-control" placeholder="5-digit Access Code" name="Acc_code" maxlength="5" pattern="[0-9]+" required="true">
			</div>
		</div>
