...
session_start();
//error_reporting(0);
date_default_timezone_set('Asia/Kolkata'); // Set the desired timezone (e.g., Asia/Kolkata for UTC+5:30)
...
if (isset($_POST['submit'])) {
    ...
    $email = $_POST['email'];
    $appdate = $_POST['date'];
    $aaptime = date('H:i:s', strtotime($_POST['time'])); // Convert appointment time to local timezone
    $specialization = $_POST['specialization'];
    $doctorlist = $_POST['doctorlist'];
    $message = $_POST['message'];
    $aptnumber = mt_rand(100000000, 999999999);
    $cdate = date('Y-m-d', time()); // Get current date in local timezone
    ...
    if ($appdate <= $cdate) {
        ...
        $query->bindParam(':aaptime', $aaptime, PDO::PARAM_STR, 8);
        ...
        if ($LastInsertId > 0) {
            echo '<script>alert("Your Appointment Request No '.$aptnumber.' Has Been Sent. Check your status within 1 hour")</script>';
            echo "<script>window.location.href ='check-appointment.php'</script>";
        } else {
                        ...
                        <div class="col-12">
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <img src="images/slider/family-doctors-covid.jpg" class="img-fluid" alt="">
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        <img src="images/slider/Public Opinion Research.jpg" class="img-fluid" alt="">
                                    </div>
